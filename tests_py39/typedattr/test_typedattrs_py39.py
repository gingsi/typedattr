"""
Copy of the file tests/typedattr/test_typedattr.py
with types changed from typing module to builtins and collections.abc
"""
from collections import defaultdict
from collections.abc import Callable, Sequence, Iterable, Set
